...
const AddTerm = ({ isOpen, onClose, onSaveTerm }) => {
    ...
    const handleSave = () => {
      const selectedTerm = paymentType.length > 0 ? paymentType[0].label : "";
      const selectedTerminNumber = selectedTerm === "Termin Payment" ? terminNumber : 0;
      const selectedTotalTermin = selectedTerm === "Termin Payment" ? totalTermin : 0;

      // Pass selected term and corresponding values to parent
      onSaveTerm(selectedTerm, selectedTerminNumber, selectedTotalTermin);
      onClose();
    };
        ...
        >
            ...
            <ModalBody>
                ...
                <Select
                    ...
                    options={[
                        { label: "Single Payment", id: "#F0F8FF" },
                        { label: "Termin Payment", id: "#FAEBD7" },
                    ]}
                    value={paymentType}
                    searchable={false}
            ...
            <ModalFooter>
                <ModalButton onClick={handleSave} kind={KIND.secondary}>
                    Save Item
                </ModalButton>
            </ModalFooter>
        </Modal>
